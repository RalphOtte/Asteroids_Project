	...
	public class MP extends Sprite
	{
		...
		private function collisionCheck(e:Event):void 
		{
			...
			*/
			...
			{
				if (_Player2._InvincibleFrameP2 == false)
				{
					//trace("Hit an Asteroid");
					_Player2._HealthVisibleP2 = 0;
					_Player2._HealthCounterP2--;
				}
				if (_Player2._InvincibleFrameP2 == true)
				{
					//trace("Player invincible");
				}
			}
		...
		{
			if (_Player2._SpaceButtonIsDown== true)
			{
				if (!this.contains(_bullet2))
				{
					addChild(_bullet2);
					_bullet2.x = _Player2.x;
					_bullet2.y = _Player2.y;
				}
				else{}
			}
		}
		...
		private function Tile1(e:Event):void
		{
			...
			_Player.scaleY = 0.5;
			_Player.rotation = 90;
			_Player.x = (stage.stageWidth / 10) * 3;
			_Player.y = (stage.stageHeight / 4) * 2;
		
			_Player2.scaleX = 0.5;
			_Player2.scaleY = 0.5;
			_Player2.rotation = 90;
			_Player2.x = (stage.stageWidth / 10) * 3;
			_Player2.y = (stage.stageHeight / 4) * 3;
