package 
{
	...
	{
		//var splashTimer:Timer = new Timer (1500, 1);
		...
		/*private function startScreen():void //SPLASH ART
		{
					
				
				//splashTimer = new Timer;
				splashTimer.addEventListener(TimerEvent.TIMER, tick);
				splashTimer.start();
				
				function tick(e:Event):void
				{
					trace("timer doet het ");
					stage.addEventListener(Event.ENTER_FRAME, startMenu);
					//startMenu(nul);
				}
